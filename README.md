...
### 1)Створюється матриця суміжності графа.
...
python script.py console
python script.py visual

console — запускає текстовий режим.
visual — запускає графічну візуалізацію процесу.
...
## Порівняння Backtracking i Greedy
...
### Аналіз результатів
![image](https://github.com/user-attachments/assets/7192f506-4280-42b1-bbf2-3e3274710af8)
