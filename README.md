...
Консольна версія:
bashpython3 nqueens.py console
У консольній версії користувачеві пропонується:

Ввести розмір шахової дошки (n)
Програма розв'язує задачу і виводить статистику (кількість рішень, час виконання, кроків, відкатів)
Користувач може переглянути знайдені розв'язки, вказавши кількість рішень для показу

Графічна версія (Tkinter):
bashpython3 nqueens.py visual
У графічній версії користувач може:

Вибрати розмір дошки з випадаючого списку (від 4 до 20)
...
### Аналіз результатів
![image](https://github.com/user-attachments/assets/ba98ff18-07a6-4f3d-bfea-95c36bc3644a)
